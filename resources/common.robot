...
${BROWSER}                      chrome
${username_admin}               admin@xp53beta22.com
${username_qa}                  quser@xp53beta21.com
${password_admin}               Dotbcs00
${password_qa}                  Dotbcs00
${login_url}                    https://connect-platform-2592-dev-ed.scratch.my.salesforce.com        # Salesforce instance. NoTE: Should be overwritten in CRT variables
